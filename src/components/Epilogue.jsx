...
const Epilogue = () => {
  ...
  return (
    <>
        <section id="propose" className="w-full h-[100lvh] flex flex-col items-center justify-center gap-y-6">
        ...
        <section id="contactTrigger" className="w-full h-[100lvh] relative z-10 flex items-center justify-center">
