...
import { dotsIcon, footerVideo, arrowIcon } from "../lib";
    ...
    <>
        <section className="w-full h-[200vh] flex flex-col">
            ...
            <div id="contactTrigger" className="w-full h-[100vh] relative z-10 flex items-center justify-center">
                <div id="contactBg" className="w-[30%] relative h-[85%] overflow-hidden rounded-t-[2000px] rounded-b-[20px] shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
                    ...
                    <video key={footerVideo} className="absolute top-0 left-0 z-[-1] w-full h-full object-cover" autoPlay={true} loop={true} playsInline={true} muted={true} controls={false}>
                    ...
                    <div className="w-full h-full flex flex-col">
                        <div className="w-full h-[11%] lg:pl-5 flex items-center justify-center">
                            ...
                            <ul className="flex items-center gap-x-10 font-nohemiMedium">
                                <li>
                                    <a href="https://www.linkedin.com/in/enosintech/" target="_blank" className="hover:opacity-70 active:opacity-50">LINKEDIN</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="https://twitter.com/intentionalgeek" target="_blank" className="hover:opacity-70 active:opacity-50">TWITTER</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="w-full lg:h-[50%] h-[70%] flex lg:flex-row flex-col items-center lg:items-start pt-14 justify-between px-10">
                            ...
                            <div className="lg:max-w-[40%] lg:w-[40%] -translate-y-14 lg:h-full h-[60%] flex flex-col">
                                ...
                                <div className="w-full h-[20%] flex items-center justify-center lg:justify-end px-2">
                                    <div className="p-4 mt-5 rounded-full bg-white hover:opacity-70 active:opacity-50">
