...
const Epilogue = () => {
  ...
  return (
    <>
        <section id="propose" className="w-full h-[100vh] flex flex-col items-center justify-center gap-y-6">
        ...
        <section id="contactTrigger" className="w-full h-[100vh] relative z-10 flex items-center justify-center">
