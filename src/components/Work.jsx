...
const Work = () => {
  ...
  return (
    <>
        <section id="work" className="w-full h-[400vh] flex flex-col relative z-20 bg-black">
          <div id="workPin" className="w-full h-screen absolute z-10 top-0 overflow-hidden flex items-center justify-center">
          ...
          <div id="bgVideoTrigger" className="w-full h-screen"></div>
        </section>
    </>
  )
}
